<x-admin-dashboard>
    <div class="container items-center px-4 py-1 m-auto mt-5">
        <div class="flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0">
          ...
          <div class="w-full p-2 lg:w-1/4 md:w-1/2">
            <div
              ...
              <h1 class="text-2xl sm:text-3xl xl:text-4xl font-bold text-gray-700 mt-12 group-hover:text-gray-50">03:20%
              </h1>
